...
field_of_view = 5;
calibration_set = 'PlenCalCVPR2013DatasetE';
...
[correspondences_struct,boardSize,framesUsed] = generate_correspondences_struct(lenses_coordinates,connection_array,data_dir,imagefiles,resolution,scale,field_of_view,1);
...
save(['data/',calibration_set,'/framesUsed-',calibration_set,'.mat'],'framesUsed');
...
data_scale = [100,1,1;1,1,1;10^12,10^20,1;1,1,1;repmat([100,100,10;1000,1000,1000],nfiles,1)];
