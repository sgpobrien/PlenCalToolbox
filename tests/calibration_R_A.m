...
save(['data/Calib-',calibration_set,'/calibration_init-',calibration_set,'.mat'],'calibration_init');
...
save(['data/Calib-',calibration_set,'/calibration_est-',calibration_set,'.mat'],'calibration_est');
