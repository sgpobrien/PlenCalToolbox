...
grid_size = 7; % size in millimeters of calibration grid squares
data_scale = [10,1,1;1,1,1;10^(12),1,1;1,1,1;repmat([1,1,1;1000,1000,1000],nfiles,1)]; % optimisation prescaling parameters
